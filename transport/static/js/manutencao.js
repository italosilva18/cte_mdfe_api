    ...
    return new Promise((resolve, reject) => {
        ...
        carregarTodasAsPlacas()
            .then(result => {
                ...
                if (plates.length > 0) {
                    console.log(`${plates.length} placas carregadas com sucesso`);
                    showNotification(`${plates.length} placas carregadas com sucesso`, 'success', 2000);
                } else {
                    showNotification('Nenhum veículo cadastrado. Cadastre um veículo antes de registrar manutenções.', 'warning', 4000);
                }
