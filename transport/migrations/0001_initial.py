# Generated by Django 4.2.20 on 2025-04-29 01:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'CT-e – Protocolo',
        ...
        migrations.AddField(
            model_name='ctecomplemento',
            name='cte',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='complemento', to='transport.ctedocumento'),
        ),
        migrations.AddField(
            model_name='ctecarga',
            name='cte',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='carga', to='transport.ctedocumento'),
        ),
        migrations.CreateModel(
        ...
        migrations.AlterIndexTogether(
            name='ctedocumento',
            index_together={('processado', 'data_upload'), ('modalidade', 'data_upload')},
        ),
        migrations.CreateModel(
